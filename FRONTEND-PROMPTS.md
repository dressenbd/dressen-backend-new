...
- GET /api/product/promo-products - Get ALL products that have any promo category
- GET /api/product/promo-category/:promoCategoryId - Get products by specific promo category
...
Optionally show featured promo products using GET /api/product/promo-products to display all products with any promotional offer.
```
...
### New API Endpoints
- ✅ `GET /api/product/promo-products` - Fetch ALL products with any promotional category
- ✅ `GET /api/product/promo-category/:id` - Fetch products by specific promo category
- ✅ Use promo-products for "All Offers" page or homepage featured section
